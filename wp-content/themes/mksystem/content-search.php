...
<?php if ( 'product' == get_post_type() ) : // Hide category and tag text for pages on Search ?>

<article id="post-<?php the_ID(); ?>" <?php post_class('col-md-3'); ?>>
	<header class="entry-header page-headerx">
	...
	<div class="entry-summary">
		...
		<?php the_excerpt(); ?>
		<p><a class="btn btn-default read-more" href="<?php the_permalink(); ?>"><?php _e( 'Ver producto', 'dazzling' ); ?> <i class="fa fa-chevron-right"></i></a></p>
	</div><!-- .entry-summary -->
	<?php else : ?>
